...
//    BoundingBox limites = new BoundingBox(new Point3d(-2f, -2f, -2f), new Point3d(2f, 2f, 2f));
    ...
    private final String RUTA_OBJETO = "src\\img\\objetos\\table.obj";
    ...
    private void definirTransicion(TransformGroup grupoPrincipal) {
        Alpha alpha = new Alpha(2, Alpha.DECREASING_ENABLE, 0, 0, 0, 0, 0, 10000, 0, -5000);
        Transform3D transformacion3D = new Transform3D();
        PositionInterpolator desplazar = new PositionInterpolator(alpha, grupoPrincipal, transformacion3D, 0, 1f);
        ...
        Scene escena = cargarObjeto(RUTA_OBJETO);
    ...
    public static void main(String[] args) {
        Mesa mesa = new Mesa();
        Frame frame = new MainFrame(mesa, FRAME_WIDTH, FRAME_HEIGHT);
    }
}
